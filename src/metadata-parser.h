...
/** \brief Metadata fields that are utilized internally by librealsense
    ...
    {
    public:
        virtual rs2_metadata_type get(const librealsense::frame& frm) const = 0;
        virtual bool supports(const librealsense::frame& frm) const = 0;
    ...
    *   http://stackoverflow.com/questions/1929887/is-pointer-to-inner-struct-member-forbidden*/
    ...
    {
    public:
        rs2_metadata_type get_fps(const librealsense::frame & frm)
        {
